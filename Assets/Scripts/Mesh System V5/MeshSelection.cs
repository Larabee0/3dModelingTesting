    ...
    public class MeshSelection : MonoBehaviour
    {
        ...
        private void SelectionSystemBackend(GameObject Item, bool BoxSelect)
        {
            ...
            if (PrimarySelectedObject == null)
            {
                ...
                {
                    PrimarySelectedObject = SelectedList[SelectedList.Count - 1];
                    PrimarySelectedObject.GetComponent<TriDataStore>().InvolvedEdgeObjects.ForEach(i => i.GetComponent<MeshRenderer>().material = PrimarySelectedMat);
                }
            ...
            else
            {
                ...
                {
                    PrimarySelectedObject.GetComponent<TriDataStore>().InvolvedEdgeObjects.ForEach(i =>i.GetComponent<MeshRenderer>().material = SecondarySelectedMat);
                    PrimarySelectedObject = SelectedList[SelectedList.Count - 1];
                    PrimarySelectedObject.GetComponent<TriDataStore>().InvolvedEdgeObjects.ForEach(i => i.GetComponent<MeshRenderer>().material = PrimarySelectedMat);
                }
            }
        ...
        {
            Item.GetComponent<TriDataStore>().InvolvedEdgeObjects.ForEach(i =>i.GetComponent<MeshRenderer>().material = SecondarySelectedMat);
            SelectedList.Add(Item);
        }
        ...
        public void Deselect(bool DestroyHandles)
        {
            ...
            {
                SelectedList.ForEach(j => j.GetComponent<TriDataStore>().InvolvedEdgeObjects.ForEach(i => i.GetComponent<MeshRenderer>().material = DeselectedMat));
            }
        ...
        public void DoHandlesStuff()
        {
            ...
            {
                PrimarySelectedObjectPosition = SpawnedHandle.transform.position = this.transform.TransformPoint(PrimarySelectedObject.GetComponent<TriDataStore>().Position);
            }
        }
        #endregion
    }
